...
struct aligned_deleter { void operator()(void* p) { free(p); } };
...
bool FFT()
{
    ...
    ScopedAlignedArrayXVEC unity( (XVEC*)aligned_alloc(16, sizeof(XVEC) * 32) );
...
bool FFTUnswizzle()
{
    ...
    ScopedAlignedArrayXVEC output((XVEC*)aligned_alloc(16, sizeof(XVEC) * 4));
    ...
    ScopedAlignedArrayXVEC output( (XVEC*)aligned_alloc(16, sizeof(XVEC) * 8) );
